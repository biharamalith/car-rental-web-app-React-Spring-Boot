      ...
      {loadingCar ? (
        ...
        <>
          ...
          {/* <form
            ...
            className={disable ? styles.disable : ""}
          >
            <label htmlFor="dateSelect">Pick up date</label>
            <select
              id="dateSelect"
              value={selectedDate}
            ...
            <input
              ...
              max="5"
              min="1"
              onChange={handleSetRentalPeriod}
              value={rentalPeriod}
              disabled={disable}
            />
            <span>days</span>
            ...
            />
            <br />
            <span>Mobile: {carOwner.mobile && carOwner.mobile}</span>
            <button disabled={disable}>Rent Car</button>
          </form> */}
        </>
      )}
    </main>
